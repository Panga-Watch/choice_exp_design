...
```{r}
ffd <- gen.factorial(c(2,2,3), varNames = c("SOS", "info", "own"), factors = "all") # construct a full factorial design which has two 2 level attributes and one 3 level attribute. factors = "all" indicates that all arguments are factors
ffd

#SOS: 1 = No, 2 = Yes
#info: 1 = non-anon/available to everyone, 2 = anon/available to everyone
#own: 1 = Public access, 2 = Industry, 3 = Government
```
...
set.seed(5)
alt1 <- transform(alt1, r1 = runif(12))
alt1

#do the same to alt2
set.seed(6)
alt2 <- transform(alt2, r2=runif(12))
alt2
